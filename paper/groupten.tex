...
% TODO
% Figure 2— Describe the isochrones in the caption . Isochrones of log(age) ≈
% 8.4 from MIST (black) and PARSEC (blue) models are plotted in Figure 2a for
% comparison. I would start the analysis section with a question: is group 10 a
